...
public class Session {
    ...
    @JoinTable(name = "Appointment", joinColumns = {@JoinColumn(name = "session_id")}, inverseJoinColumns = {
    ...
    public Session(LocalDate date, LocalTime startTime, Duration duration, int capacity, String location,
                   Person counselor) {
        this.date = date;
    ...
    public boolean equals(Object o) {
        ...
        if (startTime != null ? !startTime.equals(session.startTime) : session.startTime != null)
            return false;
        if (duration != null ? !duration.equals(session.duration) : session.duration != null)
            return false;
        if (location != null ? !location.equals(session.location) : session.location != null)
            return false;
        if (counselor != null ? !counselor.equals(session.counselor) : session.counselor != null)
            return false;
